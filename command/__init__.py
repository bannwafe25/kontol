...
from .calculator_command import (calculator_callback, inline_calculator,
                                 kalkulator_cmd)
from .callback_command import (acc_page,
                               callback_alert, callback_cancel,
                               callback_streamings, cb_help, cb_markdown,
                               cb_notes, cek_expired_cb, cine_plax,
                               closed_bot, closed_user, contact_admins,
                               del_userbot, dl_ytsearch, get_bio,
                               get_font, news_, next_font,
...
from .inline_command import (alive_inline, button_inline, cardinfo_cmd, cat_cmd,
                             catur_cmd, detcnn_cmd,
                             font_cmd, game_cmd, get_inline_help,
                             get_inline_note, help_cmd, infoinline_cmd,
                             inline_afk, inline_anime,
                             inline_autobc, inline_bmkg,
                             inline_cancel, inline_card_info,
...
from .search_command import (alkitab_cmd, chord_cmd,
                             infoanime_cmd, maps_cmd,
                             pantun_cmd, pastebin_cmd, tafsir_cmd)
from .sosmed_command import (pinterst_search,
                             youtube_search)
...
from .toxic_command import alfabet_cmd
