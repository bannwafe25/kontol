...
from command import (acc_page, back_home,
                     ...
                     tools_userbot, user_aggre, viewchord, viewgempa, waifu_next, waifu_close)
...
async def _(client, callback):
    try:
        ...
        elif query.startswith("waifu_next"):
